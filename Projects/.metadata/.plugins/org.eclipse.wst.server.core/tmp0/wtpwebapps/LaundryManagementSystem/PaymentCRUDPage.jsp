...
<body>
    ...
    <section class="crud-buttons">
        <div class="crud-action">
            <a href="PaymentPage.jsp"><button id="createBtn">Create</button></a>
            <p>Click to add a new entry. The 'Create' action opens a form for adding details to the system.</p>

        </div>

        <div class="crud-action">
            <a href="PayDetailsRead.jsp"><button id="readBtn">Read</button></a>
        ...
        <div class="crud-action">
            <a href="PaymentUpdate.jsp"><button id="updateBtn">Update</button></a>
        ...
        <div class="crud-action">
            <a href="PaymentDelete.jsp"><button id="deleteBtn">Delete</button></a>
